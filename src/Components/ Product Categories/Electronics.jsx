import React, { useContext, useEffect, useState } from "react"; // Fix: use react-router-do
...
const Electronics = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Electronics | Bukla Bazaar</title>
      </Helmet>
      <div className="bg-gray-100 dark:bg-gray-900 text-black dark:text-white text-center px-12 py-20">
        <h1 className="text-3xl mt-32">Electronics products</h1>
        <p className="text-lg mt-4">
          Explore a wide range of electronics products including smartphones,
