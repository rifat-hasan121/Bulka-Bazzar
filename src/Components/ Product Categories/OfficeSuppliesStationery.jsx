...
const OfficeSuppliesStationery = () => {
    ...
    <>
      ...
      <div className="bg-gray-100 dark:bg-gray-900 text-black dark:text-white text-center px-12 py-20">
        ...
        <p className="text-lg mt-4">
          Explore a wide range of office supplies and stationery products
          including pens, paper, notebooks, and more.
        </p>
...
export default OfficeSuppliesStationery;
