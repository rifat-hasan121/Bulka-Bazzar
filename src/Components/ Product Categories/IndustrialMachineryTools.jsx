...
const IndustrialMachineryTools = () => {
  const [products, setProducts] = useState([]);
  // This component can be used to display electronics products
  useEffect(() => {
    const category = "Industrial Machinery & Tools";
    fetch(
  ...
  return (
    <>
      <Helmet>
        <title>Industrial Machinery Tools | Bukla Bazaar</title>
      </Helmet>
      <div className="bg-gray-100 dark:bg-gray-900 text-black dark:text-white text-center px-12 py-20">
        <h1 className="text-3xl mt-32">Industrial Machinery Tools </h1>

        <p className="text-lg mt-4">
          Explore a wide range of industrial machinery and tools products
          including power tools, hand tools, and more.
        </p>
...
export default IndustrialMachineryTools;
