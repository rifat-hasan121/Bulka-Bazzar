...
const Login = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Login | Bukla Bazaar</title>
      </Helmet>
      <div
        className="bg-[url(https://i.pinimg.com/736x/d2/64/65/d264656c53a4c0f70d26f4e14864b350.jpg)] 
      dark:bg-[url(https://wallpaperaccess.com/full/4893666.jpg)] dark:text-white bg-no-repeat bg-center bg-cover py-28 flex justify-center items-center"
      >
